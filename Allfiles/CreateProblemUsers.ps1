...
#   Update the emailAddress for 'Beth Burke' to “Beth @adatum.com”
...
# Update emailAddress for 'Beth'
$emailBeth = Get-ADUser Beth -Properties emailAddress | Select emailAddress
If ($emailBeth.emailAddress -notlike "Beth @adatum.com"){
	Set-ADUser Beth -emailAddress "Beth @adatum.com"
	Write-Host "Beth was updated successfully"
} Else {
	Write-Host "Beth was ALREADY updated"
}
