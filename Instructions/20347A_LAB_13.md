...
2. In the Web Application Proxy Configuration Wizard, on the  **Welcome** page, select **Next**.
...
1. On LON-DS1, connect to https://portal.office.com and sign in as Beth@adyyxxxxx.hostdomain.com with the password you created in Module 1. Connect to the new Office 365 admin center if necessary.

2. Change Beth's user name to use the Adatumyyxxxxx.onmicrosoft.com alias rather than Adatumyyxxxxx.hostdomain.com. Beth cannot change the Adatumyyxxxxx.hostdomain.com to a federated domain if she is logged in using an account from this domain.
