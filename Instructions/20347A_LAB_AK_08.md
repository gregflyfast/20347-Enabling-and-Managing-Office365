...
9. Select  **Skip for now**.

10. Sign in as  **Beth@Adatumyyxxxxx.hostdomain.com**, replacing *yyxxxxx* with your unique Adatum number, with the password you created in Module 1.

11. Save the sign-in information. In the **Help Make Skype for Business Better!** dialog box, select  **No**.

12. Open PowerPoint. Select the option to create a blank presentation.

13. Enter **Title text** in the first slide and then save the presentation to the Documents folder using the name  **Presentation.pptx**.

14. Close PowerPoint.

15. In Outlook, select the broadcast meeting request and select  **Accept**. 

16. In the Reminders pop-up window, double-click the meeting request.

17. Select  **Join the Meeting**. 

18. In the Skype for Business window, sign in as  **Beth@Adatumyyxxxxx.hostdomain.com**, replacing *yyxxxxx* with your unique Adatum number, with the password you created in Module 1, and then select  **Join the event**.

19. In the  **Did you mean to switch apps?** window, select **Yes**.

20. In the Join Meeting Audio dialog box, select  **Don't join audio** and select **OK**. 

21. Ignore the warning about setting up an audio device if it appears.

22. In the Meeting window, select  **Share Content**, and then select  **Share PowerPoint Files**.

23. Browse to the  **Documents** folder, select **Presentation.pptx**, and then select  **Open**.

24. In the right side of the meeting window, select  **Content only**, and then select  **Start Broadcast**. 
...
25. Select  **Start Broadcast** again. Wait for the broadcast to start.

26. On LON-CL4, signed in as Ada, in Outlook, accept the meeting request from Beth. 

27. Open the meeting request, and then select  **Join the Meeting**.

28. In the Skype for Business window, sign in as  **Ada@Adatumyyxxxxx.hostdomain.com**, replacing *yyxxxxx* with your unique Adatum number, with the password you created in Module 1, and then select  **Join the event**.

29. On LON-CL3, in the broadcast window, select  **Stop Broadcast**, and then select  **Stop Broadcast** again.

30. On both LON-CL1 and LON-CL4, disconnect from the meeting.

31. Keep the virtual machines running for the next lab.
