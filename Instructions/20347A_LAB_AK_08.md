...
5. In the  **credentials** dialog box, enter the user name **Beth@Adatumyyxxxxx.hostdomain.com** and the password you created in Module 1, and then select  **OK**.
...
2. In the Skype for Business window, select  **Change**. In the  **Sign-in address** box, type **Beth@Adatumyyxxxxx.hostdomain.com** and then select **OK**.
...
17. In the Skype for Business window, sign in as  **Beth@Adatumyyxxxxx.hostdomain.com** with the password you created in Module 1, and then select  **Join the event**.
...
27. In the Skype for Business window, sign in as  **Ada@Adatumyyxxxxx.hostdomain.com** with the password **Pa55w.rd**, and then select  **Join the event**.
