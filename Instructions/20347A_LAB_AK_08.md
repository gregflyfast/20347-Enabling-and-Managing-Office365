...
7. Select **Enable Skype Meeting Broadcast**.

8. Select **Allow organizers to schedule anonymous meetings**.

9. Select **Allow broadcast meetings to be recorded**.
...
16. Open Microsoft Edge, open the **Skype for Business admin center**.

17. On the left-hand side, select  **organization**.
...
19. Under mobile phone notifications, verify that  **Apple** **Push Notification Service** is not enabled, and then select **external communications**.
...
8. In the Test broadcast meeting - Appointment window, select  **Send Update**.
...
4. On the Auto Account Setup page, fill in the following information, and then select  **Next**:
  ...
  - Password:  Password you created in Module 1

5. In the Microsoft Outlook dialog box, type the password you created in Module 1 as the password, select **Remember my credentials**, and select  **OK**. 
