...
5. In the Office 365 admin center, on menu on the left, in  **Admin centers**, select  **Teams**.
...
19. In the Office 365 admin center, on menu on the left, in  **Admin centers**, select  **Teams**.
