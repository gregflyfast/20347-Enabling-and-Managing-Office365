...
2. Sign in as  **Abbi@Adatumyyxxxxx.hostdomain.com**, with the password of  **Pa55w.rd**. 
...
6. On the  **Site Permissions** page, approve Abbi Skinner's access request, and then add Perry Brill to the site members group.

7. Access the site again as Abbi and verify that she has access. 
