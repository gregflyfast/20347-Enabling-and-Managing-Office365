...
4. Sign in as **Beth@adatumyyxxxxx.hostdomain.com** with the password you created in Module 1.
...
8. Select **Add*, select  **Beth Burke**, select  **add**, and then select  **Done**.
...
2. Expand **Microsoft Managed Controls**, then expland each item.
