...
7. Right-select  **Adatumyyxxxxx.hostdomain.com**, and then select  **New Host (A or AAAA)**.
...
5. Sign in as **Beth@Adatumyyxxxxx.onmicrosoft.com** with password created in Module 1

6. Select **Federation with AD FS**.
...
10 Select **LON-DS1**, then select **OK**.
...
13. In the **SUBJECT NAME PREFIX** box enter **AV4HAXA** and select **Next**.
...
21. On the **AD FS service account** page, select **Create a group Managed Service Account**, then select **Next**.
...
25. Select **Verify**.
  ...
  > You may need to select **Verify** mulitple times to verify external DNS.
