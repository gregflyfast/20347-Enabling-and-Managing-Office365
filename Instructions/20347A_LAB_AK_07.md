...
11. In the  **Select Members** window, next to **Check names** enter **Sales@Adatumyyxxxxx.hostdomain.com**, select  **Check names**, select **add**enter  **Sales@Adatumyyxxxx.hostdomain.com**, select  **Check names**, select **add**, and then select  **OK**.
...
7. In the  **Select Members** window, next to **Check names** enter **Sales@Adatumyyxxxxx.hostdomain.com**, select  **Check names**, select **add**, and then select  **OK**.
...
10. Type the following command, where *yyxxxxx* is your unique Adatum number, and then press Enter:
...
11. Type the following command, where *yyxxxxx* is your unique Adatum number, and then press Enter:
