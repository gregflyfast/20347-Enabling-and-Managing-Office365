...
30. Type  **Beth@Adatumyyxxxxx.hostdomain.com**, replacing *yyxxxxx* with your unique Adatum number, and **Pa55w.rd** in the Windows Security dialog box.
...
11. On LON-CL1, select  **Start**, type  **Outlook** and then select **Outlook 2016**. If prompted, type  **Beth@Adatumyyxxxxx.hostdomain.com**, replacing *yyxxxxx* with your unique Adatum number, and **Pa55w.rd** in the Windows Security dialog box.
