...
<<<<<<< HEAD
4. In the Office 365 admin center, in the menu to the left, go to  **Setup**, select  **Domains**, and then review the domain names assigned to the  **Adatum** tenant.
=======
...
5. In the Domains window, select  **Adatumyyxxxxx.hostdomain.com**.
...
<<<<<<< HEAD
4. Click, and then right-select  **adatumyyxxxxx.hostdomain.com**, and then select  **New Alias (CNAME)**.
=======
4. Click, and then right-click  **adatumyyxxxxx.hostdomain.com**, and then select  **New Alias (CNAME)**.
>>>>>>> 564fac958c055fa078a71c9b7d1045dffc25797e
...
<<<<<<< HEAD
8. Right-select  **adatumyyxxxxx.hostdomain.com**, and then select  **New Mail Exchanger (MX)**.
=======
8. Right-click **adatumyyxxxxx.hostdomain.com**, and then select  **New Mail Exchanger (MX)**.
>>>>>>> 564fac958c055fa078a71c9b7d1045dffc25797e
...
1. On LON-DC1, right-select the **adatumyyxxxxx.hostdomain.com** zone, and then select **Other New Records**.
...
11. Switch back to LON-CL1, and then in the Office 365 admin console, select  **Check DNS**.
=======
10. In the  **Resource Record Type** dialog box, select **Done**.
...
<<<<<<< HEAD
20. In the Office 365 portal, select  **Mail**.
...
11. In the  **Sign-in address** text box, type **Francisco@adatumyyxxxxx.hostdomain.com**, and then select  **Perform Test**.
...
8. On the next page, type  **Beth@adatumyyxxxxx.onmicrosoft.com**, type the password you created in Module 1 as password, select  **Keep me signed in** and then select **Next**.
...
5. In the  **Windows Security** dialog box, type the password you created in Module 1 as the password, select **Remember my credentials**, and then select  **OK**. 
...
3. On the  **Skype for Business sign in** page, type **Beth@adatumyyxxxxx.onmicrosoft.com** as the **Sign-in address**, and then select  **Sign in**.
...
5. On LON-CL2, repeat steps 1 through 4 by using the following information:
...
4. On the  **second Sign in** page, type the password you created in Module 1 as the password, select **Save my password**, and select  **Sign In**. 
