...
1. On  **LON-CL1**, create a copy the Office Deployment Tool **configuration-Office365-x86.xml** file in the **C:\\Office 16** folder created earlier by saving a copy as **Adatumconfiguration-Office365-x86.xml**.

2. By using  **Notepad**, open the  **configuration-Office365-x86.xml** file and edit the first Add line after &lt;Configuration&gt; to read **&lt;Add SourcePath="\\\\LON-CL1\\Office16\\" OfficeClientEdition="32" Branch="Current"&gt;**.
...
8. Type  **setup.exe /download \\\\LON-CL1\\Office16\\Adatumconfiguration-Office365-x86.xml** to start the download of Office 365 ProPlus.
...
5. In the Office 365 admin center, open the **Office software downloads settings** page.

6. On the  **Software download settings** page, disable downloads for all PC and mobile applications.
...
7. Create a new text document with the following line:  **\\\\LON-CL1\\Office16\\setup.exe /configure \\\\LON-CL1\\Office16\\Adatumconfiguration-Office365-x86.xml**.
