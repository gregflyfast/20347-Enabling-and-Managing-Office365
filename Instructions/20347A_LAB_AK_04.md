...
2. On the IdFix Directory Syncronization Error Remediation Tool page, select  **Download** and select **Save**.

3. Wait for the download to complete, and then select  **Open folder**.

4. In the **Downloads** folder, right-select **IdFix.zip**, and then select  **Extract All...**
...
19. In the  **UPDATE** column, log select the Logan Boyle error, and replace the string with **logan@adatum.com**, and then in the  **ACTION** column, select **EDIT**.

20. In the  **UPDATE** column, log select the Maj Hojski error, and replace the string with **maj@adatum.com**, and then in the  **ACTION** column, select **EDIT**.
...
11. In  **File Explorer**, right-select  **AzureADConnect.msi**, and then select  **Install**.
...
6. On the taskbar, right-select  **Windows PowerShell**, and then select  **Run as Administrator**.
