...
11. Verify that  **yourdomain.hostdomain.com** is listed in the text box after the at sign (@), where  *yourdomain* is your unique domain name, and then select **Add**.

12. On the  **User was added** page, note the temporary password here: ........................

13. Select  **Send email and close**.
...
2. On the right side, beside  **Display name**, select  **Edit**.

3. On the  **Edit contact information** page, expand **Contactinformation**, and in the  **Department** text box, type **Accounts**, select  **Save**, and then select  **Close**.
...
4. On the left side menu, point to  **Groups**, select  **Groups**, and then select  **Add a group**.
...
7. On the left side menu, point to  **Users**, and then select  **Active users**.
...
3. Select the  **en\\msoidcl_64.msi** check box, and then select **Next**.

4. When prompted, select  **Save**.
...
9. In Microsoft Edge, browse to  [**http://aka.ms/siqtee**](http://aka.ms/siqtee), and then select  **Save**.

10. After  **AdministrationConfig-en.msi** finishes downloading, select **Run**.

11. In the Microsoft Azure Active Directory Module for Windows PowerShell Setup wizard, select  **Next**.

12. On the  **License Terms** page, select **I accept the terms in the License Terms**, and select  **Next**.

13. On the  **Install Location** page, select **Next**.

14. On the  **Ready to Install** page, select **Install**.

15. In the  **User Account Control** dialog box, select **Yes**.

16. On the  **Completing the Microsoft Azure Active Directory Module for Windows PowerShell Setup** page, select **Finish**.
...
9. To license Catherine Richard, at the command prompt, type the following command, and then press Enter; replace *Adatumyyxxxxx* in the -AddLicenses attribute with the onmicrosoft.com domain name provided by the hosting provider:

  ```
  Set-MsolUserLicense -UserPrincipalName Catherine@yourdomain.hostdomain.com -AddLicenses "Adatumyyxxxxx:ENTERPRISEPREMIUM"
  ```

10. To license Tameka Reed, at the command prompt, type the following command, and then press Enter; replace Adatumyyxxxxx in the -AddLicenses attribute with the onmicrosoft.com domain name provided by the hosting provider:
...
4. On the left-hand side, point to  **Users**, select  **Active users**, and then select  **Francisco Chaves**.
...
9. Under Edit user role, select  **Customized administrator**, and then select  **Password administrator** from the list.
...
17. In the Office 365 admin center, on the Home page, select  **Users**, and then select  **Jessica Jennings**.

18. On the  **Jessica Jennings** page, in the **Display name** section, select **Edit**.
...
25. In the  **User name** text box, type **Chris**, select  **Add**, in Product licenses section, enable Office365 E5 license, and then select  **Send email and close**. 
