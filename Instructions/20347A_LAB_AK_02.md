...
=======
2. Next to Fransisco's email address, select  **Edit**.
...
=======
8. Next to Fransisco's email address,  select  **Edit**.
>>>>>>> 564fac958c055fa078a71c9b7d1045dffc25797e
...
13. Sign in as  **Christie@Adatumyyxxxxx.hostdomain.com**, where  *yourdomain* is your unique domain name, with the temporary password that you recorded in Lab A, Exercise 1.
