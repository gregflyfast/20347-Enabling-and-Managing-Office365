...
3. Under  **Set user location**, select  **United Kingdom**, and then enable  **Office 365 Enterprise E5**.

4. Set the  **Office 365 ProPlus** option to **Off**, select  **Save**, and then select  **Close** twice.

5. In the  **Office 365 admin center**, under  **Active users**, select  **Beth Burke**.

6. Beside  **Product licenses**, select  **Edit**.

7. Under  **Location**, select  **United Kingdom**, and then enable  **Office 365 Enterprise E5**.

8. Verify that Beth has permission to use all features.

9. Select  **Save**, and then select  **Close** twice.

10. Repeat steps 8 through 12 for  **Cai Chu**. 
...
21. On the  **Sign in** page, in the **Name** box, type **beth@AdatumYYXXXXX.hostdomain.com**.
...
38. Do not install, but notice that this user can now install the 32-bit version of Office 365 ProPlus and select which language they want to install. 
    They must select  **Advanced** to turn on the 64-bit version option.
