...
1. On LON-CL1, connect to Skype for Business Online by running the following commands in Windows PowerShell. Use Beth's credentials to connect:
    ```
    $cred = Get-Credential
...
3. In Outlook 2016, accept the broadcast meeting request from Beth. 
