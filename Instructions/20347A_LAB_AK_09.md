...
6. In the empty text box, type  **marketing**.
...
3. Sign in as  **abbi@Adatumyyxxxxx.hostdomain.com**, with the password of  **Pa55w.rd**. 
...
11. Verify that Abbi's request is listed, and select  **Approve**.

12. Select  **Site Settings**, and then select  **Site permissions**.

13. Select  **marketing Members**.

14. Verify that Abbi's account is listed. 
...
25. In the  **To** box, type the email address for your Microsoft jasonaccount, and then in the **Subject** box, type **Shared Document**.
